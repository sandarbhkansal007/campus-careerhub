...
export function SApply() {
    ...
    const drive = location.state?.drive; // Use optional chaining
    ...
    const HandleEligibilityCheck = () => {
        console.log("Student UG:", student.ug);
        console.log("Student Qualification:", student.quali);
        console.log("Drive Eligibility Criteria:", drive.eligibilityCriteria);
        console.log("Drive Qualification:", drive.qualification);
        if (student.ug >= drive.eligibilityCriteria && student.quali === drive.qualification) {
                ...
                <div className="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96">
                    ...
                    <div className="flex">
                        <div className="p-6 pt-0">
                            <a href="/student/viewjob" className="inline-block">
